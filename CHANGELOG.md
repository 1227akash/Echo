...
## 4.2.0 (ECHO Open-Source Release) — Made by Akash

### Rebranding & Open Source Architecture
- **Official rebrand to ECHO**:
  - Transformed brand identity into **ECHO**, featuring a new acoustic wave design on vibrant blue.
  - Developer credits updated to **Made by Akash**.
  - Updated all app strings across 13 locales, Settings About Card, and launcher metadata to ECHO.
- **Streaming & Scrobbler Fidelity**:
  - 100% preservation of the YouTube Music client engine, search, mixes, and background playback.
  - Complete Last.fm scrobbler integration for background media session tracking and taste discovery.
- **Security & Cryptography**:
  - JNI native secrets bridge, audio DSP decoders, and encryption preserved intact.
- **Documentation**:
  - Added comprehensive `INSTALLATION.md` and `ACCESSIBILITY.md` guides for open-source accessibility and distribution.
